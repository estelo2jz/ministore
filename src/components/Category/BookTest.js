  ...
  return (
    <div className="para-container">
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN090517')} className="addToCart cart1">
      ...
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN1611291')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN170119')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN1701148')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN40407')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN6897')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN8721')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN9505')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>     
       </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('JDN40206')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('N15116')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <p onClick={() => props.addBasket('N170530')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
      <div className="image">
        ...
        <h3 className="jewel-price">$12,580,00</h3>
        <p onClick={() => props.addBasket('N170703')} className="addToCart cart1">
          <button className="button">Add to Cart</button>
        </p>      
      </div>
    </div>
